...
Readers may wish to review this :ref:`simple annotated data example <acmg-variant-pathogenicity-statement-example>` illustrating application of VA-Spec models, before diving in to the full documentation.  A :ref:`richer annotated example<acmg-variant-pathogenicity-statement-example-with-evidence>` demonstrating more complex structures supported by VA-Spec models is also available.
...
Importantly, the level of maturity of core and profile models, and the specific elements within each, are tracked according to the `GKS Maturity Model <https://vrs.ga4gh.org/en/stable/appendices/maturity_model.html>`_ - so adopters have a clear understanding of the stability and use of elements they employ in their systems.
