...
Readers may wish to review this :ref:`simple annotated data example <variant-pathogenicity-statement-simple>`, illustrating application of VA-Spec models, before diving in to the full documentation.  

A :ref:`richer annotated example<variant-pathogenicity-statement-with-evidence>` illustrating more complex structures supported by VA-Spec models is also available.
