...
to cover the diversity of variation concepts that are annotated with knowledge in different curation efforts and knowledgebases.
...
This definition covers:
    ...
    **Non-sequence** variations in the state of a program that unfolds 'downstream' of sequence
    ...
    Different levels of **'representational specificity'** at which these variations can be described
     ...
     * **Canonical Variation**: sets of Discrete Variation instances that are related via lift-over, or projection functions (or combinations thereof).
            e.g. the set of discrete variants in ClinGen 'canonical allele' CA127512 (`link <http://reg.clinicalgenome.org/redmine/projects/registry/genboree_registry/by_caid?caid=CA127512>`_)
