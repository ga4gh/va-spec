...
**VA Standard Profiles** are the models that implementers can use to represent and exchange variant knowledge in their data systems. They are built as specializations of the :ref:`Statement<Statement>`, :ref:`EvidenceLine<EvidenceLine>`, :ref:`Statement<Proposition>`, or :ref:`Study Result<StudyResult>` classes in the VA Core Model - defined to represent specific type of knowledge about genetic variation.  
