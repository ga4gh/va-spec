...
**Artifacts**
 - `Source YAML <https://github.com/ga4gh/va-spec/blob/1.0.0-snapshot.2025-02/schema/va-spec/acmg-2015/pathogenicity-statement-profile-source.yaml>`_
 - `JSON Schema <https://github.com/ga4gh/va-spec/blob/1.0.0-snapshot.2025-02/schema/va-spec/acmg-2015/json/VariantPathogenicityStatement>`_
...
.. note::  A VA Standard Profile for this type of Statement is not explicitly defined in the VA-Spec, \
    ...
    this type of Statement. See `here <https://github.com/ga4gh/va-spec/blob/1.0.0-snapshot.2025-02/tests/fixtures/Exp-Var-Func-Impact-Statement-01.yaml>`_ for a data example.
