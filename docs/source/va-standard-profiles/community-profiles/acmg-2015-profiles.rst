...
Profiles are authored as YAML-based specifications defining **constraints** on top of the core class definitions, from which machine-readable JSON Schema and user-facing Web Documentation are automatically generated by `GKS Metaschema Tooling <https://github.com/ga4gh/gks-metaschema>`_. 
