...
.. code-block:: yaml
  ...
  VariantPathogenicityProposition:
    ...
    properties:
      object:                                      # narrows the inherited 'object' property IN PLACE, under
                                                     # the same name -- the MSP forbids renaming an inherited
                                                     # property, so there is no 'extends' keyword
        oneOf:
