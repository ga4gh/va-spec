...
This page builds on the conceptual overview of the Profiling Approach :ref:`here <profiles>`, to describe the technical mechanisms used to define profile specilaizations. 
