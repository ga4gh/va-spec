...
**Version 1 of the VA-Spec includes the following Community Profile Sets:**
...
###############################
This Profile Set includes VA standard Profiles that support representation data generated using ACMG-based pathogenicity interpretation guidelines or terminologies.
...
Here, the **Statement** profile can represent final classifications of a variant, and the **Evidence Line** profile can describe how functional data is interpreted as evidence for these classifications. 
