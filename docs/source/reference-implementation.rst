...
gkm-core. It is currently used in `MetaKB <https://github.com/cancervariants/metakb>`_
and `GKM ClinVar-This <https://github.com/clingen-data-model/clinvar-this>`_.
