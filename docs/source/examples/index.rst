...
Additional examples of real data from implementing systems can be found in the `tests/fixtures <https://github.com/ga4gh/va-spec/tree/1.0.0/tests/fixtures>`_ directory.
