...
**Complex Data Type** classes hold collections of related fields that are used to capture values of certain attributes in the primary classes (e.g. see the many attributes that take a :ref:`MappableConept <MappableConcept> as thier value).
