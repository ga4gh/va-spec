...
In a **Statement**, a proposition may be *asserted* to be true or false, or *assessed* to report the current level of confidence/evidence supporting it (e.g. "there is presently *moderate* evidence *supporting* the proposition that *'HRAS:c.173C>T causes Costello Syndrome'"*). This role of propositions is highlighted in the data example below. 
...
In an **Evidence Line**, a proposition captures the possible fact toward which evidence items are assessed and scored (e.g. that gnomAD population frequency evidence items are evaluated toward proposition that *"HRAS:c.173C>T causes Costello Syndrome"* when assessing the evidence as   providing *moderate* *support*). This role of propositions is highlighted in the data example below. 
