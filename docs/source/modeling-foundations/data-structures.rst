 ...
 * Each Evidence Line may be linked to zero or more Evidence Items (e.g. **Study Results**) that were used to build its evidence-based argument.
...
In this structure:
 * An **Evidence Line** roots a central axis where it is linked zero or more Evidence Items (e.g. **Study Results**) that were used to build the arguemnt it represents.
 ...
 * As for Statements, classes surrounding this central axis are used to describe the provenance of the Evidence Lines and its Evidence Items.
