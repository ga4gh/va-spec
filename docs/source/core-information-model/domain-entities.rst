...
**Examples**
  - `A discrete allele as a VRS object <https://github.com/ga4gh/va-spec/blob/1.0.0-snapshot.2025-02/tests/fixtures/allele.yaml>`_
  - `A canonical allele as a Cat-VRS object <https://github.com/ga4gh/cat-vrs/blob/1.0.0-snapshot.2025-02/examples/canonicalAllele-ex1.yaml>`_
...
**Examples**
 - `Nonsyndromic genetic hearing loss as a Mappable Concept <https://github.com/ga4gh/va-spec/blob/1.0.0-snapshot.2025-02/tests/fixtures/VA-ClinVar-SCV-Example-002.yaml#L7>`_
...
**Examples**
  - `A set of two co-occurring phenotypes <https://github.com/ga4gh/va-spec/blob/1.0.0-snapshot.2025-02/tests/fixtures/traitset.yaml>`_
...
**Examples**
  - `Afatinib as a Mappable Concept <https://github.com/ga4gh/va-spec/blob/1.0.0-snapshot.2025-02/tests/fixtures/therapeuticAgent.yaml>`_
...
**Examples**
  - `A combination treatment of Arsenic Trioxide and Tretinoin <https://github.com/ga4gh/va-spec/blob/1.0.0-snapshot.2025-02/tests/fixtures/therapy-group.yaml>`_
...
**Examples**
  - `BRCA2 gene as a Mappable Concept <https://github.com/ga4gh/gks-core/blob/1.0.0-snapshot.2025-02/examples/mappable-concept-gene.yaml>`_
