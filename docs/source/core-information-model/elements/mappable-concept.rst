...
- Another example illustrating a MappableConcept representing a Gene can be found `here <https://github.com/ga4gh/gks-core/blob/1.0.0-snapshot.2025-02/examples/mappable-concept-gene.yaml>`_.
