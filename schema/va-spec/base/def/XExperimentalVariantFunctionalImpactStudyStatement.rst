...
Some XExperimentalVariantFunctionalImpactStudyStatement attributes are inherited from :ref:`gks-core:Statement`.
...
.. list-table::
   ...
   *  - proposition
      - 
      - :ref:`XExperimentalVariantFunctionalImpactStudyProposition`
      - 1..1
