...
Some XVariantTherapeuticResponseStudyStatement attributes are inherited from :ref:`gks-core:Statement`.
...
.. list-table::
   ...
   *  - proposition
      - 
      - :ref:`XVariantTherapeuticResponseStudyProposition`
      - 1..1
      - Reports the conclusion of the study, which is that the subject variant is associated with therapeutic sensitivity or resistance to the object therapeutic.    
