...
Some XVariantDiagnosticStudyStatement attributes are inherited from :ref:`gks-core:Statement`.
...
.. list-table::
   ...
   *  - proposition
      - 
      - :ref:`XVariantDiagnosticStudyProposition`
      - 1..1
      - The proposition for which the study provides evidence - that the subject variant is associated with the object disease.          
