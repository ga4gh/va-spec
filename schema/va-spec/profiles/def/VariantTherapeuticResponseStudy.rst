...
Some VariantTherapeuticResponseStudy attributes are inherited from :ref:`VariantStudySummary`.
    ...
    .. list-table::
       ...
       *  - therapeutic
          - `TherapeuticProcedure <../../gks-common/therapeutics.json#/$defs/TherapeuticProcedure>`_ | `IRI <../../gks-common/common.json#/$defs/IRI>`_
          - 1..1
